...
namespace Mediator.Examples
{
    ...
    class MainApp
    {
        static void Main()
        {
            ...
            ConcreteColleague3 c3 = new ConcreteColleague3(m); // Added ConcreteColleague3
            m.Colleague1 = c1;
            m.Colleague2 = c2;
            m.Colleague3 = c3; // Set Colleague3 in the mediator
            m.Send("How are you?", c1);
            m.Send("Fine, thanks", c2);
            m.Send("Hello!", c3); // Sending a message from Colleague3
            // Wait for user
            Console.Read();
        }
    }
    ...
    class ConcreteMediator : Mediator
    {
        ...
        private ConcreteColleague3 colleague3; // Added Colleague3
